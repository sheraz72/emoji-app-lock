...
import com.sh_developers.emojilocker.model.FaviterInfo;
...
public class LoadAppListService extends IntentService {
    ...
    public void onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationUtil.createNotification(this," Emoji App Lock","Emoji App lock Services running in background");
        }
    }
