package com.sh_developers.emojilocker.services;
...
import com.sh_developers.emojilocker.LockApplication;
...
import com.sh_developers.emojilocker.receiver.LockRestarterBroadcastReceiver;
import com.sh_developers.emojilocker.utils.NotificationUtil;
...
public class LockService extends IntentService {
    ...
    public void onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationUtil.createNotification(this, "Emoji Lock Screen", "Emoji Lock Screen running in background");
        }
    }
